...
def standings():
    ...
    with col1:
        st.metric('Away', "Dad Bod Bombers", 12)
    with col2:
        st.metric('Home', "Pitch Slaps", 8)
    ...
    st.write("### Game 13 - 7/27/2023")
    col1, col2 = st.columns(2)
    with col1:
        st.metric('Away', "Good Wood", -3)
    with col2:
        st.metric('Home', "Dad Bod Bombers", 9 )
    with st.expander("See the evidence:"):
        st.markdown('NO evidence of losses')
    st.markdown("--------")

    st.write("### Game 12 - 7/20/2023")
    col1, col2 = st.columns(2)
    with col1:
    ...
    col1, col2 = st.columns(2)
    with col1:
        st.metric('Away', "Affinity's Nuts", 7)
    with col2:
    ...
    col1, col2 = st.columns(2)
    with col1:
        st.metric('Away', "TECO WESTINGHOUSE", 20)
    with col2:
