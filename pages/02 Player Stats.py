...
def labeler():
    ...
    with st.form('selection'):
        ...
        split = st.radio("Select a Player split:", ("All-Time", 'Season 1', 'Season 2', 'Season 3', 'Season 4', 'Season 5', 'Season 6'))
    ...
    if split == 'All-Time':
        ...
        temporal = big_dict['player'][player]['df_s5']

    elif split == 'Season 6':
        df_agg = big_dict['df_agg_s6']
        df_games = big_dict['df_games_s6']
        df_full = big_dict['df_s6']
        temporal = big_dict['player'][player]['df_s6']
